...
export default function BottomNav() {
  ...
  return (
    ...
    <nav
      className="fixed bottom-0 left-0 right-0 z-[100] bg-white/80 backdrop-blur-sm pb-safe md:hidden"
      ...
      <div className="flex items-stretch h-16">
        {NAV_ITEMS.map(({ href, label, icon: Icon }) => {
          ...
          return (
            ...
            >
              {/* Figma: ativo #38B1E4 Bold, inativo #707A7E Medium */}
              <Icon
                className="h-6 w-6"
                style={{ color: isActive ? "#38B1E4" : "#707A7E" }}
