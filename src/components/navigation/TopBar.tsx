...
import { ChevronDown, User, Home, Search, BookOpen, FileText, LogOut, LogIn, Check, UserPlus, UserCircle } from "lucide-react";
...
export default function TopBar({ title }: TopBarProps) {
  ...
  // Label e iniciais do perfil ativo
  ...
  return (
    <>
      ...
      >
        <div className="flex items-center justify-between h-14 px-4 max-w-[1200px] mx-auto">
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            {dropdownOpen && user && (
              <div
                className="absolute right-0 mt-2 w-56 rounded-2xl overflow-hidden py-1 z-50"
                style={{
      ...
      <AddDependentSheet open={addDependentOpen} onClose={() => setAddDependentOpen(false)} />
    </>
  );
}
