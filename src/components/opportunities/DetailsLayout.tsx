        ...
        <div className="max-w-[75%]">
          ...
          {campus && (
            <div className="flex flex-wrap gap-2 mt-2">
              ...
              <span className="text-[11px] font-bold text-white px-3 py-1 rounded-full" style={{ backgroundColor: '#3092bb' }}>
      ...
      return (
        <div className={floatShell}>
          ...
          <button
            onClick={handleApply}
            disabled={isDisabled}
            className={`${btnBase} text-white shadow-2xl ${shadow} active:scale-95 disabled:opacity-70 disabled:cursor-not-allowed hover:opacity-80`}
