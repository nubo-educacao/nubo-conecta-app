...
export interface IHomeSection {
  ...
  data_source: 'featured_opportunities' | 'partner_opportunities' | 'recent_opportunities' | 'match_results' | 'institutions' | 'institutions_with_open_opps' | 'important_dates' | 'static';
